...
namespace OpenPr0gramm
{
    ...
    public class InboxController : Pr0grammController
    {
        ...
        public Task<GetMessagesResponse<PrivateMessage>> GetMessages(string with, long? older = null) => Client.Inbox.GetMessages(with, older);
        public Task<GetConversationsResponse> GetConversations(long? older = null) => Client.Inbox.GetConversations(older);
